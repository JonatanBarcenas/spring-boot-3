...
public class MedicoController {
    ...
    @PostMapping
    public ResponseEntity<DatosRespuestaMedico> registrarMedico(@RequestBody @Valid DatosRegsitroMedico datosRegsitroMedico,
                                                                UriComponentsBuilder uriComponentsBuilder){
       Medico medico = medicoRepository.save(new Medico(datosRegsitroMedico));
